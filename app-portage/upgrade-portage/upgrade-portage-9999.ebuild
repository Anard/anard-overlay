...
RDEPEND=">=sys-apps/portage-3.0 app-portage/eix <gnome-extra/zenity-4 || ( lxqt-base/lxqt-openssh-askpass net-misc/ssh-askpass-fullscreen net-misc/x11-ssh-askpass ) color? ( >=scripts/shell-text-1.0-r2 )"
DEPEND="${RDEPEND}"
